...
$sqluser = "powerbars";				// The user able to controle the database
$sqlpass = "nwKWsFV";				// The user's password to controle the database
$sqlbase = "powerbars";				// The name of the database in MySQL
...
$comadr  = "/dev/ttyS1";			// The COM port: windows >> COMX, Linux >> /dev/ttySX
						// Where X = the comport number
						// Or incase of USB  /dev/ttyUSB0
